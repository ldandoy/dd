...
def questEscape(self):
    ...
    backgroundImagePath = os.path.join(self.base_folder, '../medias/questEscape.png')
    ...
    mainCanvas.create_text(w/2, h/10, fill='white', anchor='c', text="You choose to fly away!", font=labelTextcityFrame_config, justify='center')
